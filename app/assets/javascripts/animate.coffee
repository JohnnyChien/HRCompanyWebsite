...
class @ScrollTransition
  ...
  constructor: (options = {}) ->
    ...
    @scrollTransitionEvent = @util().createEvent(@config.boxClass)
  ...
  show: (box) ->
    ...
    @util().emitEvent(box, @scrollTransitionEvent)
  ...
  applyStyle: (box, hidden) ->
    duration  = box.getAttribute('data-transition-duration')
    delay     = box.getAttribute('data-transition-delay')
    iteration = box.getAttribute('data-transition-iteration')
  ...
  isVisible: (box) ->
    offset     = box.getAttribute('data-transition-offset') or @config.offset
